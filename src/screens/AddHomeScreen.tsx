...
import { useAddHomeViewModel } from '../viewmodels/AddHomeViewModel';
...
const AddHomeScreen = ({ navigation }: any) => {
  ...
  // ── Submit handler — calls the real API via ViewModel ──────
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '800', color: GREEN_NAVY },

  uploadBox: {
    marginTop: 16, height: 200, borderRadius: 16,
    backgroundColor: UPLOAD_BG, borderWidth: 1.5,
    borderColor: UPLOAD_BORDER, borderStyle: 'dashed',
    overflow: 'hidden',
  },
  uploadPlaceholder: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  cameraIconWrapper: { position: 'relative', marginBottom: 10 },
  plusBadge: {
  ...
  uploadText: { fontSize: 14, color: TEXT_DARK, fontWeight: '500' },
  uploadedImage: { width: '100%', height: '100%' },

  locationCard: {
    marginTop: 18, backgroundColor: '#FAFAFA', borderRadius: 14,
  ...
  locationLabel: { fontSize: 12, color: TEXT_MUTED, marginBottom: 4 },
  locationValue: { fontSize: 17, fontWeight: '700', color: TEXT_DARK },
  divider: { height: 1, backgroundColor: BORDER },

  errorBanner: {
    marginTop: 14, backgroundColor: '#FFEBEE',
  ...
  input: {
    ...
    padding: 14, minHeight: 100, fontSize: 14,
    color: TEXT_DARK, backgroundColor: '#fff',
  },

  submitButton: {
    marginTop: 22, backgroundColor: GREEN_NAVY,
    paddingVertical: 16, borderRadius: 14, alignItems: 'center',
    shadowColor: GREEN_NAVY, shadowOffset: { width: 0, height: 4 },
